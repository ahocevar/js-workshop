# -*- coding: utf-8 -*-
#
# JavaScript Workshop Modules documentation build configuration file, created by
...
modindex_common_prefix = ['javascript.']
...
htmlhelp_basename = 'JavaScriptWorkshopdoc'
...
latex_documents = [
  ('index', 'JavaScriptWorkshop.tex', u'JavaScript Workshop Documentation',
   u'OpenGeo', 'manual'),
]
